...
import 'package:bobocomp/taxi/modals/user_model.dart';
...
import 'package:bobocomp/taxi/helper/ui_helper.dart';
...
class MenuWidget extends StatefulWidget {
  ...
  MenuWidget({Key key, this.currentMenuPercent, this.animateMenu, this.signOut})
      : super(key: key);
...
class _EditProfileState extends State<EditProfile> {
  ...
  Image _image =
      Image.asset('assets/avatar.png', width: realH(320), height: realH(320));
          ...
          children: <Widget>[
            ...
            RaisedButton(
              ...
              onPressed: () async {
                ...
                // String url = _dpUrl;
                // if(_dp != null){
                //   url = await userModule.uploadImage(_dp);
                // }
